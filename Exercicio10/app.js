...
let cat = {
  ...
  age: 1,
  color: "Laranja",
  bestFriends: ["Bartolomeu", "Edgar", "Norman"],
...
const colorCat = (newColor) => {
  newColor["color"] += ` e branco`;
};
...
const valorBooleanObj = (valor) => {
  return typeof valor === "object";
};

console.log(valorBooleanObj(cat));
...
let dog = {
  ...
  age: 2,
  color: "Laranja",
  bestFriends: ["Toby", "Bruce", "Chico"],
};

const somaIdade = cat.age + dog.age;
console.log(`A soma das idades de ${cat.name} e ${dog.name} é ${somaIdade}.`);
...
console.log(funcType("undefined"));
